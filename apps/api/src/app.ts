...
export async function buildApp(opts: { logger?: boolean } = {}) {
  ...
  await app.register(adminMemberFieldsRoutes, { prefix: "/api/v1" });
  await app.register(adminNotificationsRoutes, { prefix: "/api/v1" });
  await app.register(adminApprovalsRoutes, { prefix: "/api/v1" });
  await app.register(adminWorkflowsRoutes, { prefix: "/api/v1" });
